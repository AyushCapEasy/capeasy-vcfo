    ...
    <div className="relative min-h-full bg-canvas">
      ...
      <header className="border-b border-line bg-white">
        <div className="mx-auto max-w-5xl px-6 py-4">
          <div className="flex flex-wrap items-start justify-between gap-4">
            <div>
              <h1 className="font-serif text-2xl font-semibold tracking-tight text-ink">Financials</h1>
      ...
      <main className="mx-auto max-w-5xl space-y-6 px-6 py-6">
        ...
        <div className="grid gap-6 lg:grid-cols-2">
          <Section title="Profit & Loss" subtitle="Schedule III format · this period vs prior year · tap a line to see the accounts behind it">
          ...
          <Section title="Balance Sheet" subtitle="Schedule III format · what you own and owe · this period vs prior year">
        ...
        {/* Ratios */}
        <Section title="Key ratios &amp; working capital" subtitle="Liquidity, profitability and efficiency at a glance">
        ...
        <p className="pb-4 text-center text-xs text-muted">
          Generated by CapEasy vCFO · <span className="font-semibold">automatically checked for internal consistency</span> and <span className="font-semibold">CA-reviewed</span>. More analysis is on the <Link href={`/clients/${orgId}/insights?p=${periodMeta.id}`} className="font-medium text-primary hover:underline">Insights</Link> tab.
        </p>
      </main>
    </div>
  );
