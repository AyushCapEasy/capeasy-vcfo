  ...
  return (
    <main className="flex flex-1 items-center justify-center p-6">
      <div className="card max-w-md p-10 text-center">
        ...
        <h1 className="mt-1.5 text-xl font-bold text-ink">Not found</h1>
        <p className="mt-1.5 text-sm text-muted">This page doesn’t exist, or you don’t have access to it.</p>
